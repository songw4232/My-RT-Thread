...
```C++
void WorkerManager::Show_Menu()//作用域！！也必须写上面！
{
	cout << "********************************************" << endl;
...
public:
	...
	//显示个人信息
	virtual void showInfo() = 0;//纯虚函数，在子类重写该函数！！！
	//获取岗位名称
...
//员工类
class Employee :public Worker    //员工继承职工的抽象基类！！
{
public:
...
void Employee::showInfo()
{
	cout << "职工编号： " << this->m_Id
		<< " \t职工姓名： " << this->m_Name
		<< " \t岗位：" << this->getDeptName()
		<< " \t岗位职责：完成经理交给的任务" << endl;//可以和上面的getDeptName，一样写一个函数！！
}
...
普通员工类**继承**职工抽象类，并重写父类中纯虚函数；在初始化操作！！
...
void WorkerManager::Add_Emp()
{
	...
	{
		//计算新空间大小
		int newSize = this->m_EmpNum + addNum;//新空间人数=原来的人数+新增人数
